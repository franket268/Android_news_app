...
import com.example.ui.SearchActivity;
...
public class SettingAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(null==convertView)
        {
        	...
        	_Holder.item_layout=(RelativeLayout) convertView.findViewById(R.id.item_layout);
        ...
        _Holder.item_layout.setOnClickListener(new OnClickListener() {
