...
public class InternationFragment extends Fragment implements OnClickListener{
	...
	public void buildView(){
		...
		mFocusList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				intent.putExtra("categoryName", getActivity().getResources().getString(R.string.international));
